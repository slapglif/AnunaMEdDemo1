...
login(token='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')

peft_model_id = "/content/drive/MyDrive/llama_7b_medqa_finetuned/"
...
# Load the Lora model
fine_tuned_model = PeftModel.from_pretrained(llama2, peft_model_id)
model = fine_tuned_model.merge_and_unload()
